...
Public Class DGVEmpListFrmDel
    ...
    Private Sub dgvEmpRecs_MouseUp(sender As Object, e As MouseEventArgs) Handles dgvEmpRecs.MouseUp
        Try
            FrmDeliveryTran.txtEmpID.Text = Me.dgvEmpRecs.CurrentRow.Cells(0).Value
            FrmDeliveryTran.txtEmpName.Text = Me.dgvEmpRecs.CurrentRow.Cells(1).Value
